    ...
    describe('Notes', function () {
        describe('Create note', function () {
            ...
            it('respond with 201 created', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/notes/new')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(201);
    ...
    describe('Tags', function () {
        describe('Create tag', function () {
            ...
            it('respond with 201 created', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/notes/26/tags/new')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(201);
    ...
    describe('Users', function () {
        describe('Update user', function () {
            ...
            it('respond with 200 updated', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/update')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(200);
    ...
    describe('Notes', function () {
        describe('Update note', function () {
            ...
            it('respond with 200 updated', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/notes/26')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(200);
    ...
    describe('Tags', function () {
        describe('Update tag', function () {
            ...
            it('respond with 200 updated', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/notes/26/tags/6')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(200);
    ...
    describe('Users', function () {
        describe('Delete user', function () {
            ...
            it('respond with 200 deleted', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/delete')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(200);
    ...
    describe('Notes', function () {
        describe('Delete note', function () {
            ...
            it('respond with 200 deleted', function (done) {
                ...
                agent.post('http://localhost:3000/api/v1/profile/notes/25')
                    .type('form')
                    .query(data)
                    .then(res => {
                        expect(200);
